package medilux.aquabe.common.error;
...
import medilux.aquabe.common.error.exceptions.ServiceUnavailableException;
import medilux.aquabe.common.error.exceptions.UnauthorizedException;
import medilux.aquabe.common.payload.ConstraintExceptionDto;
import medilux.aquabe.common.payload.ErrorResponseTemplate;
